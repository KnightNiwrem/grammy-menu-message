...
export class MenuTemplate {
   ...
   * @param payload Optional payload string to pass to the middleware as third argument
   * @returns this for method chaining
   */
  cb(label: string, middleware: MenuMiddlewareFn, payload?: string): this {
    this.operations.push({
      type: "cbButton",
      label,
      middleware,
