...
import type { MenuButtonHandler } from "../types.ts";
...
/**
 * RangeBuilder is responsible for building and managing a sequence of button operations.
 * It provides methods to declaratively add various types of buttons and organize them into rows.
 *
 * @template C The grammY Context type
 */
export abstract class RangeBuilder<C extends Context> {
  protected operations: Operation<C>[] = [];

  /**
   * @internal
   * Sets the operations array for this range.
   *
   ...
   */
  _setOperations(operations: Operation<C>[]) {
