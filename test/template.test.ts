...
describe("MenuBuilder", () => {
  describe("button methods", () => {
    it("should add rawCb button", () => {
      const template = new MenuBuilder<Context>("Test message").rawCb("Test", "callback_data");
    ...
    it("should add cb button with handler", async () => {
      ...
      const template = new MenuBuilder<Context>("Test message").cb("Test", handler);
      const menu = template.render("template", "rendered");
    ...
    it("should add url button", () => {
      const template = new MenuBuilder<Context>("Test message").url("Visit", "https://example.com");
      const menu = template.render("template", "rendered");
    ...
    it("should add webApp button with string URL", () => {
      const template = new MenuBuilder<Context>("Test message").webApp("Open App", "https://app.example.com");
      const menu = template.render("template", "rendered");
    ...
    it("should add webApp button with WebAppInfo object", () => {
      ...
      const template = new MenuBuilder<Context>("Test message").webApp("Open App", webAppInfo);
      const menu = template.render("template", "rendered");
    ...
    it("should add login button with string URL", () => {
      const template = new MenuBuilder<Context>("Test message").login("Login", "https://example.com/login");
      const menu = template.render("template", "rendered");
    ...
    it("should add login button with LoginUrl object", () => {
      ...
      const template = new MenuBuilder<Context>("Test message").login("Login", loginUrl);
      const menu = template.render("template", "rendered");
    ...
    it("should add switchInline button", () => {
      const template = new MenuBuilder<Context>("Test message").switchInline("Share", "test query");
      const menu = template.render("template", "rendered");
    ...
    it("should add switchInline button with default empty query", () => {
      const template = new MenuBuilder<Context>("Test message").switchInline("Share");
      const menu = template.render("template", "rendered");
    ...
    it("should add switchInlineCurrent button", () => {
      const template = new MenuBuilder<Context>("Test message").switchInlineCurrent("Insert", "inline query");
      const menu = template.render("template", "rendered");
    ...
    it("should add switchInlineChosen button", () => {
      ...
      const template = new MenuBuilder<Context>("Test message").switchInlineChosen("Choose", query);
      const menu = template.render("template", "rendered");
    ...
    it("should add switchInlineChosen button with default empty query", () => {
      const template = new MenuBuilder<Context>("Test message").switchInlineChosen("Choose");
      const menu = template.render("template", "rendered");
    ...
    it("should add copyText button with string", () => {
      const template = new MenuBuilder<Context>("Test message").copyText("Copy", "Text to copy");
      const menu = template.render("template", "rendered");
    ...
    it("should add copyText button with CopyTextButton object", () => {
      ...
      const template = new MenuBuilder<Context>("Test message").copyText("Copy", copyTextButton);
      const menu = template.render("template", "rendered");
    ...
    it("should add game button", () => {
      const template = new MenuBuilder<Context>("Test message").game("Play Game");
      const menu = template.render("template", "rendered");
    ...
    it("should add pay button", () => {
      const template = new MenuBuilder<Context>("Test message").pay("Pay Now");
      const menu = template.render("template", "rendered");
  ...
  describe("row method", () => {
    it("should create a new row", () => {
      const template = new MenuBuilder<Context>("Test message")
        .cb("Button 1", async () => {})
        .row()
        .cb("Button 2", async () => {});
  ...
  describe("render method", () => {
    it("should render a menu with correct IDs", () => {
      const template = new MenuBuilder<Context>("Test message").cb("Test", async () => {});
    ...
    it("should not modify native buttons' callback_data", () => {
      const template = new MenuBuilder<Context>("Test message").rawCb("Raw", "my-data");
      const menu = template.render("template", "rendered");
    ...
    it("should include payload in menuButton when provided", () => {
      const template = new MenuBuilder<Context>("Test message").cb("Test", async () => {}, "my-payload");
      const menu = template.render("template", "rendered");
