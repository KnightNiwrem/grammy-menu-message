...
describe("MenuRegistry", () => {
  ...
  describe("register", () => {
    ...
    it("should allow registering multiple templates", () => {
      const registry = new MenuRegistry<Context>();
      const template1 = new TextMenuTemplate<Context>("Test message");
      const template2 = new TextMenuTemplate<Context>("Test message");
    ...
    it("should allow overwriting a template", () => {
      const registry = new MenuRegistry<Context>();
      const template1 = new TextMenuTemplate<Context>("Test message").cb("Button 1", async () => {});
      const template2 = new TextMenuTemplate<Context>("Test message").cb("Button 2", async () => {});
