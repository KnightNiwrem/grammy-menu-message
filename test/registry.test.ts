...
describe("MenuRegistry", () => {
  ...
  describe("register", () => {
    ...
    it("should allow registering multiple templates", () => {
      const registry = new MenuRegistry<Context>();
      const template1 = new MenuBuilder<Context>("Test message");
      const template2 = new MenuBuilder<Context>("Test message");
    ...
    it("should allow overwriting a template", () => {
      const registry = new MenuRegistry<Context>();
      const template1 = new MenuBuilder<Context>("Test message").cb("Button 1", async () => {});
      const template2 = new MenuBuilder<Context>("Test message").cb("Button 2", async () => {});
